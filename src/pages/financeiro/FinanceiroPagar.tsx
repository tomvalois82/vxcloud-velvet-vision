  ...
  return <div className="animate-fade-in">
      <PageHeader title="Contas a Pagar" description="Gerencie despesas e pagamentos" action={<div className="flex items-center gap-2">
        ...
        backgroundColor: '#0DCAF0'
            ...
            <Button variant="outline" size="icon" onClick={() => navigate("/financeiro/fast?tipo=Pagar")} title="Lançamento Rápido" className="rounded-full w-10 h-10 hover:bg-accent/10 shadow-lg shadow-accent/20 border-secondary">
